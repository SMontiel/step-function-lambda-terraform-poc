  ...
  definition = <<EOF
{
  ...
  "States": {
    ...
    "random-number-generator-lambda": {
      ...
      "Type": "Task",
      "Resource": "${module.lambda_function_random_number_generator.lambda_function_arn}",
    ...
    "power-of-three-lambda": {
      ...
      "Resource": "${module.lambda_function_power_of_number.lambda_function_arn}",
      "End": true
    },
...
EOF
  ...
  depends_on = [module.lambda_function_power_of_number.lambda_function_arn, module.lambda_function_random_number_generator.lambda_function_arn]

  tracing_configuration {
    enabled = true
  }
  // only valid for: type = "EXPRESS"
